    ...
    if($("#contactform").length!=0){
        $("#contactform").submit(function (e) {
            ...
            if (name === '' || !IsEmail(email) || message === '') {
                ...
                $.ajax({
                    type: "POST",
                    url: "assets/php/PHPMailer/submit.php",
                    data: dataString,
                    success: function (data) {
						...
						if(data == 'true')
						{
							$('#valid-issue').html("The message has been sent.").show();
						}
						else
						{
							$('#valid-issue').html("Something went wrong, please send an email directly to info@georgetown.co.za").show();
						}
